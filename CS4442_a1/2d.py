...
# -------------------- Part d) where we are repeating b) -------------------------
...
# Creating our matrix for x with column of 1's and column of x^2's
...
plot1 = plt.figure(1)
plt.title("2nd-Order Polynomial Regression and Training Data", color="black")
...
# -------------------- Part d) where we are repeating c) -------------------------
...
h_test = w_0 * x2_test + w_1 * x1_test + w_2

# Finally plotting our regression model and test data
plot2 = plt.figure(2)
plt.title("2nd-Order Polynomial Regression and Testing Data", color="black")
